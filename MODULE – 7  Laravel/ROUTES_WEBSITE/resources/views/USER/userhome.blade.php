        ...
        <div class="row">
          <div class="col-md-6 ">
            <div class="detail-box">
              ...
              <p>
                I am a result-oriented IT professional with experience in development and
                implementation of websites using PHP, HTML5, CSS basic, Bootstrap and MySQL technology.

                I have experience in the development of web applications using XAMPP or WAMMP server.
                Expertise validation in JavaScript, CRUD operation in PHP, Knowledge of MVC in Laravel.
              </p>
              <a href="/USER/contact">
                Contact Us
              </a>
        ...
        <div class="col-lg-5 col-md-6">
          <div class="detail-box">
            ...
            <p>
              ...
              and
              I'm excited to know and use the most modern PHP frameworks and Javascript libraries involved in the
              development of modern websites,
              and scalable applications, providing unique insight and help with every aspect of your project
              development,
              from its consulting and strategy to its implementation and integration.
              This leads to a professional software development process that translates into a competitive advantage for
              my clients.
              I will tailor the software development project around your company's services, objectives, and of course,
              your budget.
            </p>
            <a href="">
              Read More
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-6 ">
          <div class="detail-box">
            <h2>
              i have experience in Professional <br>
              website building
            </h2>
            <p>
              using the Agile Methodology during the development to deliver web-based solutions,
              I can create an application that will meet your specific user, business, industry,
              or vertical needs. The Agile Methodology is not based on the classic and linear design approach, but on an
              innovative development cycle system where customer satisfaction and software efficiency are the main
              objectives. The project is splitted into short phases, called "sprint", each sprint corresponds to the
              development of a business feature at the end of which, even involving the client,
              its success is evaluated in order to easily modify the project in an "agile way" or move to the next
              sprint.
            </p>
            <a href="">
              Read More
