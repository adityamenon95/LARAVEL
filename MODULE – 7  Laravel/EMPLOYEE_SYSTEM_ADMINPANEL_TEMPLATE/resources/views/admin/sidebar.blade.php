<nav class="sidebar sidebar-offcanvas" id="sidebar">
        ...
        <ul class="nav">
          ...
          <li class="nav-item menu-items">
            <a class="nav-link" /pages/forms/basic_elements.html">
              <span class="menu-icon">
          ...
          <li class="nav-item menu-items">
            <a class="nav-link" /pages/tables/basic-table.html">
              <span class="menu-icon">
          ...
          <li class="nav-item menu-items">
            <a class="nav-link" /pages/charts/chartjs.html">
              <span class="menu-icon">
          ...
          <li class="nav-item menu-items">
            <a class="nav-link" /pages/icons/mdi.html">
              <span class="menu-icon">
