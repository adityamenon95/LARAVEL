            ...
            <div class="col-sm-6 mt-5">
                <div class="row mt-3 mb-3">
                     <div class="col text-left"> 
                        ...
                        <a href="/ADMIN/home" class="btn btn-primary">ADMIN PANEL TEMPLATE</a>
                    </div>
                    <div class="col text-right">
                        <a href="/Insert" class="btn btn-success">insert</a>
                    </div>
                </div>
                <form action="{{url('/Search')}}" method="post" enctype="multipart/form-data" style="box-shadow:0 0 10px; padding:10px;">
