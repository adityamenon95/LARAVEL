    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-sm-6 mt-5">
                <form action="/Insert" method="post" enctype="multipart/form-data" style="box-shadow:0 0 10px; padding:15px;">
                    ...
                    <div class="row mt-3">
                        <div class="col">
                            ...
                            <input type="PhoneNo" class="form-control" name="phoneno" id="" placeholder="enter phoneno">
                        </div>
                    </div>
                    @error('phoneno')
                    <div class="text-danger">
                    ...
                    <div class="row mt-3">
                        <div class="col">
                            ...
                            <textarea name="address" id="" class="form-control" placeholder="enter address" cols="5" rows="5"></textarea>
                        </div>
                    </div>
                    @error('address')
                    <div class="text-danger">
